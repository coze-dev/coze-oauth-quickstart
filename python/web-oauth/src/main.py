...
from cozepy import PKCEOAuthApp, load_oauth_app_from_config, WebOAuthApp
...
def index():
    return '''
        <h1>Coze Web OAuth Quickstart</h1>
...
def callback():
    ...
    oauth_token = coze_oauth_app.get_access_token(redirect_uri=REDIRECT_URI, code=code)
